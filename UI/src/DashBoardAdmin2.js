...
class DashboardAdmin1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      user: {},
  ...
  userActiveAdmin = (favId) => {
    fetch(
      `http://localhost:8081/api/user/activeUser?id=${favId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
                                ...
                                <Popup
                                  trigger={
                                    <Button 
                                      ...
                                      icon = "add"
                                      color = "green"
                                      onClick = {(e) => {e.preventDefault(); this.userActiveAdmin(value.id) } }
                                    />
                                  }
                                  content="Geri getir"
                                />
...
export default withRouter(DashboardAdmin1);
